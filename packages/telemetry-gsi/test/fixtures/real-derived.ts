export const REAL_DERIVED_PROVENANCE = {
  ...
  sourceFrame: 'representative sanitized observer frame excerpt',
  sanitization: 'source ids and display names replaced with stable fixture-safe values',
} as const;

export const REAL_DERIVED_OBSERVER_FRAME = {
  provider: {
    name: 'CS2',
    appid: 730,
    version: 14181,
...
export const REAL_DERIVED_ROUND_AFTER_BOMB_FRAME = {
